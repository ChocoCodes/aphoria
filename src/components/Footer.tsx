                ...
                <div className="second-group flex items-start justify-between mt-[2em] md:mt-[0] gap-15">
                    ...
                    <div>
                        ...
                        <ul className="md:text-right font-inter font-semibold mt-2">
                            <li><a href="https://www.facebook.com/dsc.usls/" className="text-white/90 text-lg" target="blank">Facebook</a></li>
                            <li><a href="https://www.instagram.com/gdg.usls/" className="text-white/90 text-lg" target="blank">Instagram</a></li>
                            <li><a href="mailto:gdg@usls.edu.ph" className="text-white/90 text-lg" target="blank">Email</a></li>
                        </ul>
                    </div>
                </div>
            </div>
