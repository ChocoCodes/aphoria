    ...
    return (
        <section className="relative bg-black w-full min-h-screen flex items-center justify-center p-8" id="about">
            ...
            >
                ...
                <div className="z-10 flex flex-col gap-5 text-white font-reddit w-full mx-auto">
                    ...
                    <p className='text-lg md:text-xl'>The first to comment the decoded message on the website to our <span className='font-bold underline'> 2025 official website posting reveal</span> post will win a <span className="font-bold">free ticket</span> inside our booth.</p>
                </div>
            </motion.div>
        </section>
    )
